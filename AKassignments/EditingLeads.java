...
public static void main(String[] args) throws InterruptedException {
    ...
    Thread.sleep(10);
	driver.findElement(By.xpath("(//input[@name='firstName'])[3]")).sendKeys("Kiruthic");
    driver.findElement(By.xpath("(//button[@class='x-btn-text'])[7]")).click();
    Thread.sleep(10);
    driver.findElement(By.linkText("16973")).click();
    ...
    driver.findElement(By.xpath("(//a[@class='subMenuButton'][3])")).click();
	  ...
	  String companyName="TATA Consultancy Service (16973)";
